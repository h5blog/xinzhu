...
/** 成员文案区：宽 926 × 高 223；底 #f2f2f2 + team-list.png；默认白描边，悬停整条卡片时为橘色 */
export default function TeamMemberTextPanel({
  ...
  return (
    <div
      className={`relative box-border flex h-[223px] w-full min-w-0 max-w-[926px] flex-1 flex-col justify-center overflow-hidden px-8 py-4 sm:px-10 lg:h-[11.6146vw] lg:max-w-[48.2292vw] lg:px-[2.0833vw] lg:py-[0.8333vw] ${borderClass} ${className}`.trim()}
      data-node-id="106:20"
    >
