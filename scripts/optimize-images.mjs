...
const targets = [
  ...
  // 加入我们「薪酬福利」图标雪碧：先 npm run build:job-perk-sprite，再导出 204w + 408w
  {
    input: "src/images/job-perk-sprite.png",
    maxWidth: 204,
    outputBase: "job-perk-sprite-1x",
    quality: 82,
    avifQuality: 68,
    avifEffort: 7,
    fallbackFormat: "png",
  ...
  {
    input: "src/images/job-perk-sprite-2x.png",
    maxWidth: 408,
    quality: 82,
    avifQuality: 68,
    avifEffort: 7,
